...
public abstract class MicroService implements Runnable {
	...
	private HashMap<Class<? extends Message>, Callback<?>> eventCallbackMap;
    ...
    public MicroService(String name) {
        this.name = name;
        eventCallbackMap = new HashMap<Class<? extends Message>, Callback<?>>();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        if(eventCallbackMap.get(type)==null)
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
				Message temp = bus.awaitMessage(this);
				if(temp!=null) {
					Callback c =eventCallbackMap.get(temp.getClass());
					c.call(temp);
				}
